...
<x-admin-layout header="Editar marca">
    ...
    <div class="max-w-2xl">
        ...
        <form action="{{ route('marcas.update', $marca) }}" method="POST" enctype="multipart/form-data"
            ...
            <div>
                ...
                @if ($marca->logo)
                    <div class="mb-2">
                        <img src="{{ asset('storage/' . $marca->logo) }}" alt="Logo actual"
                             class="h-16 w-auto object-contain border border-gray-200 rounded-lg p-1">
                        <span class="block text-xs text-gray-400 mt-1">Logo actual. Sube uno nuevo solo si quieres cambiarlo.</span>
                    </div>
                @endif
            ...
            <div class="flex items-center gap-6">
                <div>
                    ...
                    <input type="number" name="orden" value="{{ old('orden', $marca->orden) }}"
                ...
                <label class="flex items-center mt-6">
                    <input type="checkbox" name="activo" value="1" {{ $marca->activo ? 'checked' : '' }}
